...
const statistic_resolver_1 = require("./statistic.resolver");
...
exports.StatisticModule = StatisticModule = __decorate([
    (0, common_1.Module)({
        providers: [statistic_resolver_1.StatisticResolver, statistic_service_1.StatisticService, statistic_sync_service_1.StatisticSyncService, prisma_service_1.PrismaService],
        exports: [statistic_sync_service_1.StatisticSyncService],
    })
], StatisticModule);
